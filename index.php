...
<head>
    ...
    <title>Happy Holi from <?php echo $wisher_name ?></title>
</head>
<style>
    html,
    body {
...
<body>
    <canvas></canvas>
    <p>( होली खेलने के लिए स्क्रीन पर स्वाइप करें ) <a href="make_wish.php">अपने नाम से भेजें</a></P>
    <div> Happy Holi from <?php echo $wisher_name ?>
    </div>
